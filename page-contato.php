            ...
            <div class="row  justify-content-center">
              <div class="row">
                <div class="col-sm-8 pt-4 mt-4" style=" background: #fff;  min-width:60%;">
                  ...
                  <form action="<?php echo get_permalink( get_page_by_title( 'CONTATO' ) );?>" name="form_contato"
                    method="post">
                    <div class="row mt-4 pt-4">
                      ...
                      <div class="col-sm-6 " style=" background: #fff;">
                        <div class="form-group ">
                          <h5 class="text-cinza text-left font-weight-bold">Nome <sup class="asteristico">*</sup></h5>
                          <input type="text" name="nome" maxlength="40" class="  form-control border-0 bd-cinza"
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control border-0 bd-cinza" type="text" name="mensagem" rows="3"
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-2">
                        <div class="form-group text-cinza">
                          <input type="contato" class="form-control text-cinza border-0 text-center contato bd-cinza"
                            id="exampleInputEmail1" aria-describedby="emailHelp" ng-model="result"
                            placeholder="{{a +' + '+b}}" style=" color: #000000 !important; ">
                        </div>
                      </div>
