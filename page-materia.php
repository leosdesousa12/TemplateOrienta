                  ...
                  <div class="col-sm-8 pt-4 mt-3" style=" background: #fff;  min-width:50%;">
                    <div ng-repeat="materia in lista">
                      <a href="{{materia.link}}">
                        ...
                        <h5 class="text-color text-justify font-weight-normal pb-4" ng-bind-html="materia.post_excerpt">
                        </h5>
                        ...
                        <div class="row  justify-content-center">
                          ...
                          <nav aria-label="...">
                            ...
                            <ul class="pagination pagination-lg rounded-0">
                              ...
                              <li ng-class="{active:(($index ) == pageAtual)}" class="page-item rounded-0"
                              ...
                              <li class="page-item rounded-0"
                                ...
                                <a class="page-link rounded-0 ml-2 mr-2 border-2 border border-page" href="#">
                                  ...
                                </a>
                              </li>
                              ...
                              <li ng-if="(pageAtual +1) <pagina.length " ng-click="loadListPagination(pageAtual+1)"
                                class="page-item rounded-0"><a
                                  class="page-link rounded-0 ml-2 mr-2 border-2 border border-page" href="#">></a></li>
