  ...
  <div class="container mt-4">
    ...
    <div class="row justify-content-md-center ">
      <div class="col-auto mx-auto  justify-content-md-center ">
        ...
        <?php if($quant %2 !=0 ):  ?>
        <div class="card mb-4  mt-0 pt-0 mb-0 pb-0 border-0 rounded-0 "
        ...
        <?php else: ?>
        <div class="card mb-3  mt-0 pt-0 mb-0 pb-0 border-0 rounded-0 "
          style="max-width: 100%; margin-bottom:0px !important;">
          <div class="row no-gutters ">
            ...
            <div class="col-md-auto">
              <img class="card-img  mt-0 pt-0 mb-0 pb-0 border-0 rounded-0  url="
                <?php echo the_post_thumbnail('medium_large'); ?> </div>
            </div>
          </div>
          <?php endif ?>
          <?php endwhile; ?>
