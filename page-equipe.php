...
<?php get_header(); ?>
  ...
  <section class="page-section" id="contact">
    <div class="container">
    <h1 class="text-center text-primary mt-4">EQUIPE</h1>
      ...
      <div class="row justify-content-md-center ">
        <div class="col-auto mx-auto">
          ...
          <?php query_posts('post_type=equipe&post_per_page=-1'); ?>
                        ...
                        <?php if($quant %2 !=0 ):  ?>
                        <div class="card mb-3  mt-0 pt-0 mb-0 pb-0 border-0 rounded-0 " style="max-width: 600px; margin-bottom:0px !important;">
                            <div class="row no-gutters  mt-0 pt-0 mb-0 pb-0 border-0 rounded-0 ">
                                <div class="col-md-4">
                                <img  class="card-img  mt-0 pt-0 mb-0 pb-0 border-0 rounded-0 "  url="<?php echo the_post_thumbnail(); ?>
                                </div>
