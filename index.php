        ...
        <div class="col-md-12 text-center">
          <div id="myCarousel" class="carousel slide w-100" data-ride="carousel">
            <div class="carousel-inner w-100" role="listbox">
              <div class="carousel-item " ng-class="{'active text-primary':(($index ) == 0)}" ng-repeat="post in posts">

                <div class="col-lg-4 col-md-6 border-0 mr-0 pr-0 ml-0 pl-0" ng-style="{'background': post.color}">
            ...
            <a class="carousel-control-prev bg-dark w-auto pr-0" href="#myCarousel" role="button" data-slide="prev">
              <span class="carousel-control-prev-icon text-center ml-2 pl-2 pr-2 mr-2 " aria-hidden="true"></span>
              <span class="sr-only ">Previous</span>
            </a>
            <a class="carousel-control-next bg-dark w-auto pr-0" href="#myCarousel" role="button" data-slide="next">
              <span class="carousel-control-next-icon text-center ml-2 pl-2 pr-2 mr-2 " aria-hidden="true"></span>
        ...
        <div class="card border-0 rounded-0 pt-0 mt-0" style="max-width: 550px; "
          ...
          <a href="{{materia.link}}" class="pr-1">
            <img ng-src="{{materia.photo[0]}}"
              class=" card-img img-fluid img-thumbnail card-img-top pt-0 bt-0 rounded-0 border-0" alt="..."
