...
$_SESSION["idProposta"]=get_the_ID();
 ?>
...
<section class="page-section pb-3 mb-3 mt-4" id="contact">
    <div ng-controller="HomeCtrl" class="container mt-4">
        <h1 class="text-center font-weight-normal text-uppercase text-primary mb-2 mt-4" ng-bind="pagePrposta.title"></h1>

        <div class="row justify-content-md-center ">
            <div class="col-auto mx-auto  justify-content-md-center text-center ">
                <div class="duas-colunas">
                    <h4 class="text-color text-justify font-weight-normal  " ng-bind-html="pagePrposta.post_content">
                    </h4>
                </div>
                    ...
                    <div class="row no-gutters  mt-0 pt-0 mb-0 pb-0 border-0 rounded-0 ">
                        ...
                        <div class="col-md-8  bd-cinza">
                            <div class="card-body text-white h-100 card-proposta">
                                ...
                                ng-bind-html="postPrincipal.post_content"></h5>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row  justify-content-center">
                    ...
                    <div ng-if="post.post_id != postPrincipal.post_id">
                            <div ng-click="principal(post)" 
                             class="card-img text-center img-fluid img-thumbnail pt-4 mt-4 pt-0 mb-0 pb-0 border-0 rounded-0  " ng-bind-html="post.segundaImagem"></div>
